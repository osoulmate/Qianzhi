<div class="container" style="margin-bottom:10px">
    <?php if(!empty($monthView)):?>
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <?php foreach ($monthView as $article):?> 
            ...
            <ul class="pagination">
                ...
                <li class="page-item">
                    <?php echo $html->link('<i class="fa fa-angle-right"></i>',$currentLocation.'/page/2','','',' class="page-link" ')?>
                </li>

                <?php elseif (($currentPageNumber != 1)&&($currentPageNumber < $totalPages)):?>
                <li class="page-item">
                  <?php $previous=$currentPageNumber-1;echo $html->link('<i class="fa fa-angle-left"></i>',$currentLocation.'/page/'.$previous,'','',' class="page-link" ')?>
                </li>
                <li class="page-item">
                  <?php $next=$currentPageNumber+1;echo $html->link('<i class="fa fa-angle-right"></i>',$currentLocation.'/page/'.$next,'','',' class="page-link" ')?>
                </li>   
